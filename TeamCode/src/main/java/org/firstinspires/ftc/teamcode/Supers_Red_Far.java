 ...
 */
@Autonomous(name="Supers_Red_Far", group="safe")

public class Supers_Red_Far extends LinearOpMode{
...
//
          ...
          //  String keyResult = "RIGHT";
            ...
            if(keyResult == "LEFT"){
                ...
                //sleep(100);
     //           turnWithGyro("right", .75,90, parameters);
                turnRightDegrees(85, parameters);
                sleep(100);

straightWithEncoderCurve(1,19);

turnWithGyro("left",.75, 53, parameters);
...
//                sleep(1000);
                ...
                straightWithEncoderCurve(1,13);

                turnWithGyro("left",.75, 51, parameters);
...
//                sleep(1000);
                ...
                straightWithEncoderCurve(1,6);

                turnWithGyro("left",.75, 50, parameters);
