...
@Autonomous(name = "Supers_Blue_Far", group = "safe")
//@Disabled

public class SUPERS_BLUE_FAR extends LinearOpMode {    // Declare OpMode members.
...
//                rightFront.setPower(0);
                ...
                turnWithGyro("left",.75, 80, parameters);
                straightWithEncoderCurve(.9,-24);

                strafeWithEncoder(.4, -4);

                turnWithGyro("left",.75, 120, parameters);
                ...
                strafeWithEncoder(.45, 4);
                straightWithEncoder(.45,-4);

                strafeWithEncoder(.45, 7);
                straightWithEncoder(.45,-4);
                ...
                sleep(400);
                //       straightWithEncoder(1,4);

                // sleep(200);
//                leftDump.setPosition(.34);
//                sleep(1000);
                ...
                straightWithEncoder(.5,4);
                straightWithEncoder(.5,-5);
                straightWithEncoder(.4,2);
...
//                sleep(100);
//
//                straightWithEncoderCurve(.4,5);
//
//               // strafeWithEncoder(.4, -4);
//
//               // turnWithGyro("left",.5, 75, parameters);
//
//                turnLeftDegress(75, parameters);
//                sleep(300);
//               // straightWithEncoder(.4, -4);
//                leftDump.setPosition(.47);
//                sleep(500);
...
//                rightFront.setPower(0);
                ...
                turnWithGyro("left",.75, 110, parameters);
...
//                rightFront.setPower(0);
                ...
                turnWithGyro("left",.75, 95, parameters);
...
//        telemetry.addData("ticks: ", ticks);
  ...
  //      rightDump.setPosition(right);
    ...
    private void motorWithEncoderCurve(DcMotor motorName, double power, double inches) {
        ticks = (int) (inches * 1120 / (4 * 3.14159)); //converts inches to ticks
//        telemetry.addData("ticks: ", ticks);
        telemetry.update();
    ...
    private void straightWithEncoderCurve(double strength, double straightInches){
        ...
        motorWithEncoderCurve(leftBack, strength, inch75);
        motorWithEncoderCurve(leftFront, strength, inch75);
        motorWithEncoderCurve(rightBack, strength, inch75);
        motorWithEncoderCurve(rightFront, strength, inch75);
        ...
        motorWithEncoderCurve(leftBack, stren25, inch25);
        motorWithEncoderCurve(leftFront, stren25, inch25);
        motorWithEncoderCurve(rightBack, stren25, inch25);
        motorWithEncoderCurve(rightFront, stren25, inch25);
    ...
    private void turnCurve(double power) {
        //left turn is positive power
        leftBack.setPower(power); //sets left wheels to move backward
        leftFront.setPower(power);
        rightBack.setPower(power); // makes right hand wheels to move forward
    ...
    public double sCurve(double p, double o, double v, double ratio){
        double out = 0;
        out = .25+(p*(1.2-(1/(1+(Math.pow(Math.E, (-o*((v*ratio)-2.1) ) )  ) )) ) );
